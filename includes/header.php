                ...
                <div class="nav-links">
                    ...
                    <?php }else{?>
                        ...
                        <?php if($_SESSION['ruolo']=='admin'){?>
	                          <a href="/palestra/admin/dashboard.php">Dashboard</a>
	                          <a href="/palestra/admin/gestisci_coach.php">Staff Coach</a>
	                          <a href="/palestra/admin/gestisci_abbonamenti.php">Abbonamenti</a>
	                    <?php }?>
